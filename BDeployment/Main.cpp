...
#include <BDeployment/Top/BDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    BDeployment::TopologyState inputs;
    ...
    BDeployment::setupTopology(inputs);
    BDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    BDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
