module BDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    import ProjectCore.ProjectCore
  ...
  # ----------------------------------------------------------------------
    ...
    # include "BDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections ComCcsds_CdhCore {
      ...
      # CdhCore.tlmSend.PktSend -> comSplitter.comIn
      # comSplitter.comOut[0] -> ComCcsds.comQueue.comPacketQueueIn[ComCcsds.Ports_ComPacketQueue.TELEMETRY]
    ...
    connections HubBuffers {
      ProjectCore.AtoBHub.allocate -> ComCcsds.commsBufferManager.bufferGetCallee
      ProjectCore.AtoBHub.deallocate -> ComCcsds.commsBufferManager.bufferSendIn
    }
